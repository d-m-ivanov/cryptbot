...
def back_test_start():
    ...
    base_asset = input("Pleas enter base asset (for example 'btc'): ").upper()
    ...
    trading_capital = float(input("Please enter a part of your capital that going to used in trading\n"
                                  "(example - 0.2): "))
    start_month, start_day, start_year = input("Please enter start day of back testing "
                                               "in format Mount Day Year: ").split(" ")
    end_month, end_day, end_year = input("Please enter end day of back testing "
                                         "in format Mount Day Year: ").split(" ")
...
def initialize_strategy() -> SMAStrategy:
    ...
    trading_capital = float(input("Please enter a part of your capital that going to used in trading\n"
                                  "(example - 0.2): "))
    losses = float(input("Please enter part of capital you accept to lose: "))
    short_term_int = int(short_term)
    long_term_int = int(long_term)
...
def initialize_client(mode="test") -> BinanceAPIClient:
    ...
    if mode == "prod":
        api_key = input("Pleas enter your Binance API KEY: ")
        secret_key = input("Pleas enter your Binance SECRET KEY: ")
    elif mode == "test":
        api_key = input("Pleas enter your Binance API KEY for spot testnet: ")
        secret_key = input("Pleas enter your Binance SECRET KEY for spot testnet: ")
    else:
        api_key = ""
        secret_key = ""
    base_asset = input("Pleas enter base asset (for example 'btc'): ").upper()
